# TP3-Formulaire_accessible-claudielanglais
TP3- Un formulaire accessible validé avec HTML5
...
![Capture écran du projet terminé](https://github.com/claudielanglais/TP3-Formulaire_accessible-claudielanglais/blob/main/images/screencapture-127-0-0-1-5500-index-html-2026-03-29-21_59_46.png)
![Capture écran du projet terminé](https://github.com/claudielanglais/TP3-Formulaire_accessible-claudielanglais/blob/main/images/screencapture-127-0-0-1-5500-index-html-2026-03-29-22_00_12.png)

### Lien

- URL du site en ligne : [https://claudielanglais.github.io/TP3-Formulaire_accessible-claudielanglais/](https://claudielanglais.github.io/TP3-Formulaire_accessible-claudielanglais/)
...
- [Le validateur W3](https://validator.w3.org/) - Cette ressource m'a aidé pour voir les erreurs dans mon HTML.

## Auteur

- Page profil Github - [claudielanglais](https://github.com/claudielanglais) 
...
```html
<div class="main__champs-contact">
  <label for="prenom">Prénom</label>
  <input type="text" name="prenom" id="prenom" required pattern="^[a-zA-Z]{1,}">
</div>
```
...
#### Ma note d'autoévaluation pour le critère CSS : C
...
#### Ma note d'autoévaluation pour le critère JavaScript : E
...
- Le javascript et les message d'erreur ont causé des difficulté. 
- Les éléments checked et hover ont pris du temps. 
- Les éléments area assertive sont difficile à comprendre.
- Les images dans les labels ont été moins facile à placé correctement.

## Ma note d'autoévaluation pour le projet entier : 65%
